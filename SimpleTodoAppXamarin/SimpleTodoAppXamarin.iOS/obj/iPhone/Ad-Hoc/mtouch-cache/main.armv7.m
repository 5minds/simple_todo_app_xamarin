...
extern void *mono_aot_module_FormsTemplateiOS_info;
...
extern void *mono_aot_module_SimpleTodoAppXamarin_info;
...
{
	mono_aot_register_module (mono_aot_module_FormsTemplateiOS_info);
	...
	mono_aot_register_module (mono_aot_module_SimpleTodoAppXamarin_info);
...
void monotouch_setup ()
{
	...
	monotouch_assembly_name = "FormsTemplateiOS.exe";
